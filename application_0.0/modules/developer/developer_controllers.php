...
# Purpose: provide controller logic for the developer module
# 2012-09-12 ... created.
...
# Class Declaration for developer Module's Controllers
class DeveloperControllers extends Controllers
{
	...
	public function processInitialize( $param = array(), $missing = '' ) {
		...
		if( !$is_bad ) {
			...
			$messages .= 'Initialization of the developer module was successful. ';
