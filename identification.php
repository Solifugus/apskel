...
class Identity {
	...
	public function __construct() {
		...
		$this->mappings = array();
		$this->mappings[] = array( 'recognizer'=>'apskel.dev', 'application'=>'Apskel', 'environment'=>'development', 'version'=>'0.0' );
		$this->mappings[] = array( 'recognizer'=>'apskel.stg', 'application'=>'Apskel', 'environment'=>'staging',     'version'=>'0.0' );
		$this->mappings[] = array( 'recognizer'=>'apskel.com', 'application'=>'Apskel', 'environment'=>'production',  'version'=>'0.0' );
